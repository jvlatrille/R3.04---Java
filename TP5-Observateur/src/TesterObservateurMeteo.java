...
public class TesterObservateurMeteo {
    ...
    public static void main(String[] args) {
        ...
        // Partie de simulation dans une itération
        while (true) {
            ...
            System.out.println ("\n... les observateurs sont mis é jour par le design pattern ...");

            /** 2. On constate que les observateurs : afficheur et baseDeDonnées
